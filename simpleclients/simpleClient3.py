...
def main():
    if  len(sys.argv) < 2:
        ...
        if os.path.exists(xmlf):
            ...
            dpx.XMLSettings = xml
            dpx.JSONRecord = '{"data": {"comments":["emittance_x","asdfasdf"], "parameters":[["param0","key_0" ], [ "param1", "key_1" ],  [ "param2", "key_2" ],  [ "param3", "key_3"],  [ "param4", "key_4" ] ] } }'

#            dpx.JSONRecord = '{ "data":  {  "sampleTime": "0.1"   },    "comments":    [  "hallo",    "hello"    ]} '
